...
from PyQt6.QtWidgets import QApplication, QWidget, QMessageBox, QDialog, QVBoxLayout, QLabel, QPushButton
...
class LoadingScreen(QWidget):
    def __init__(self):
        ...
        self.logo = QPixmap("path/to/logo.png")  # Remplacez par le chemin de votre logo
